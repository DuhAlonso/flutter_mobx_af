...
mixin _$ImcController on ImcControllerBase, Store {
  ...
  late final _$calculateImcAsyncAction =
      AsyncAction('ImcControllerBase.calculateImc', context: context);

  @override
  Future<void> calculateImc({required double peso, required double altura}) {
    return _$calculateImcAsyncAction
        .run(() => super.calculateImc(peso: peso, altura: altura));
  }
